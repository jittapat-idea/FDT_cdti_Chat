...
class ContextualRetrieval:
    ...
    def generate_answer_api_with_history(self, query: str, retriever):
        ...
        prompt ="""
        คุณเป็นผู้ช่วยในการตอบคำถามสำหรับนักศึกษาในคณะเทคโนโลยีดิจิทัล
        ...
        - ต้องใช้ **หัวข้อ (`###`)** และ **ลำดับขั้นตอน (`1.` `1.1`)** เพื่อให้เข้าใจง่าย 
        - ถ้ามีลิงก์ ให้แสดงเป็น [ชื่อเว็บไซต์](URL)  
        - ถ้ามีข้อมูลที่ไม่สามารถให้ได้ ให้แจ้งว่า **"กรุณาติดต่อเจ้าหน้าที่"**
        ---
        ### **ข้อมูลที่ต้องตอบ**
        {context}
        """
